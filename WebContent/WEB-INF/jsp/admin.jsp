...
<script data-main="<%=basePath %>source/js/main/admin.js" src="<%=basePath %>source/js/lib/require.js"></script>
<link href="<%=basePath %>source/style/admin.css" rel="stylesheet" type="text/css" />
