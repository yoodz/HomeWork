...
require(['angular', 'angular-ui-router','angular-resource', 'modules/app/teacher'], function(angular) {
    angular.bootstrap(document, ['teacherModule']);
});
